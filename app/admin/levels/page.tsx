...
export default function AdminLevelsPage() {
  ...
  const updateLevel = (idx: number, field: keyof Level, value: string | number) => {
  ...
  const addLevel = () => {
    ...
    setLevels([...levels, { level: nextLv, name: `레벨 ${nextLv}`, requiredExp: lastExp * 2 || 100, badge: "⭐", color: "#3b82f6", bgColor: "#eff6ff" }]);
  };
